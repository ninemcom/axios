  ...
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    request.OnComplete.Add( success => {
      ...
      var response = {
        ...
        config: config
        //,request: request	// This cause JavascriptHttpRequest object leak!
      };
    ...
    if (request.GetVerb() === 'POST' || request.GetVerb() === 'PUT') {
    ...
    if (!request.ProcessRequest())
      reject(createError('could not process request', config, null, request));
  });
};
